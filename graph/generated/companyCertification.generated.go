...
func (ec *executionContext) marshalNCompanyCertification2ᚖgithubᚗcomᚋMoralᚑAuthorityᚋbackendᚋgraphᚋmodelᚐCompanyCertification(ctx context.Context, sel ast.SelectionSet, v *model.CompanyCertification) graphql.Marshaler {
	if v == nil {
	...
	return ec._CompanyCertification(ctx, sel, v)
}
...
func (ec *executionContext) marshalOCompanyCertification2ᚕᚖgithubᚗcomᚋMoralᚑAuthorityᚋbackendᚋgraphᚋmodelᚐCompanyCertificationᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.CompanyCertification) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNCompanyCertification2ᚖgithubᚗcomᚋMoralᚑAuthorityᚋbackendᚋgraphᚋmodelᚐCompanyCertification(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
