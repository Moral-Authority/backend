...
func (ec *executionContext) marshalNCompanyProduct2ᚖgithubᚗcomᚋMoralᚑAuthorityᚋbackendᚋgraphᚋmodelᚐCompanyProduct(ctx context.Context, sel ast.SelectionSet, v *model.CompanyProduct) graphql.Marshaler {
	if v == nil {
	...
	return ec._CompanyProduct(ctx, sel, v)
}
...
func (ec *executionContext) marshalOCompanyProduct2ᚕᚖgithubᚗcomᚋMoralᚑAuthorityᚋbackendᚋgraphᚋmodelᚐCompanyProductᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.CompanyProduct) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNCompanyProduct2ᚖgithubᚗcomᚋMoralᚑAuthorityᚋbackendᚋgraphᚋmodelᚐCompanyProduct(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
